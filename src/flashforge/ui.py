...
class GenerationWorker(QObject):
    ...
    def __init__(self, settings: AppSettings, material: str, image_path: Path | None = None) -> None:
        super().__init__()
    ...
    def run(self) -> None:
        try:
            ...
            cards = (
                ...
                else pipeline.generate_from_text(self.material)
            )
...
class MainWindow(QMainWindow):
    ...
    def _start_generation(self) -> None:
        ...
        self._generation_worker = GenerationWorker(self.settings, material, self._image_path)
    ...
    def _show_cards(self, cards: Sequence[Flashcard]) -> None:
        self.cards = list(cards)
        ...
        self._auto_import_pending = self.settings.auto_import_after_generation and bool(self.cards)
